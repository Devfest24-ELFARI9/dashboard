  ...
  return (
    <>
      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="hadow-lg rounded-sm border border-stroke bg-white transition-shadow duration-300 hover:shadow-2xl  dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="px-26 py-17.5 text-center">
                ...
                <p className="2xl:px-20">Welcome to Infinite Factory</p>
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                <span className="mb-1.5 block font-medium">Weclome</span>
                <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  Sign Up To Infinite Factory
                </h2>
